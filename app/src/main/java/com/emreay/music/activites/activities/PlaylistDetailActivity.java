...
import com.emreay.music.adapter.song.OrderablePlaylistSongAdapter;
import com.emreay.music.adapter.song.PlaylistSongAdapter;
...
import com.emreay.music.loader.PlaylistLoader;
...
import com.emreay.music.model.PlaylistSong;
import com.emreay.music.model.Song;
import com.emreay.music.util.PhonographColorUtil;
import com.emreay.music.util.PlaylistsUtil;
...
public class PlaylistDetailActivity extends SlidingMusicPanelActivity implements CabHolder, LoaderManager.LoaderCallbacks<ArrayList<Song>> {
