...
public abstract class AbsTestPagerRecyclerViewFragment<A extends RecyclerView.Adapter, LM extends RecyclerView.LayoutManager> extends AbsTestPagerFragment implements OnOffsetChangedListener {

    public static final String TAG = AbsTestPagerRecyclerViewFragment.class.getSimpleName();
