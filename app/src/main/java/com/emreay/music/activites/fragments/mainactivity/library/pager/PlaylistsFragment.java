...
import com.emreay.music.adapter.PlaylistAdapter;
...
import com.emreay.music.model.smartplaylist.HistoryPlaylist;
...
public class PlaylistsFragment extends AbsLibraryPagerRecyclerViewFragment<PlaylistAdapter, LinearLayoutManager> implements LoaderManager.LoaderCallbacks<ArrayList<Playlist>> {
    ...
    protected PlaylistAdapter createAdapter() {
        ...
        return new PlaylistAdapter(getLibraryFragment().getMainActivity(), dataSet, R.layout.item_list_single_row,getContext());
    }
