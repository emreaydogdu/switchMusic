package com.emreay.music.activites.fragments.player.flat_test;
...
import com.emreay.music.activites.fragments.player.PlayerAlbumCoverFragment;
import com.emreay.music.activites.fragments.player.PlayerFragment;
import com.emreay.music.adapter.base.MediaEntryViewHolder;
import com.emreay.music.adapter.song.PlayingQueueAdapter;
import com.emreay.music.dialogs.LyricsDialog;
import com.emreay.music.dialogs.SongShareDialog;
...
public class FlatTestPlayerFragment extends PlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {
    public static final String TAG = FlatTestPlayerFragment.class.getSimpleName();
    ...
    private FlatTestPlayerPlaybackControlsFragment playbackControlsFragment;
    ...
    private void setUpSubFragments() {
        playbackControlsFragment = (FlatTestPlayerPlaybackControlsFragment) getChildFragmentManager().findFragmentById(R.id.playback_controls_fragment);
    ...
    private static abstract class BaseImpl implements Impl {
        protected FlatTestPlayerFragment fragment;

        public BaseImpl(FlatTestPlayerFragment fragment) {
    ...
    private static class PortraitImpl extends BaseImpl {
        ...
        public PortraitImpl(FlatTestPlayerFragment fragment) {
            super(fragment);
        }
    ...
    private static class LandscapeImpl extends BaseImpl {
        public LandscapeImpl(FlatTestPlayerFragment fragment) {
            super(fragment);
        }
