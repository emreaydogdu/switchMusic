package com.emreay.music.adapter.song;
...
public class PlayingQueueAdapter extends SongAdapter
    //implements DraggableItemAdapter<PlayingQueueAdapter.ViewHolder>
    {
    ...
    public void onItemDragFinished (int one, int two, boolean bl) {
