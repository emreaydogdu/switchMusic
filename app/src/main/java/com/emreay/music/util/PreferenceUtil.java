...
public final class PreferenceUtil {
    ...
    public static final String FULLSCREEN_INT = "fullscreen_int";
    public static final String COLOR_NOT_INT = "color_not_int";
    public static final String COLOR_INT = "color_int";
    public static final String NAVBAR_COLOR_INT = "navbar_color_int";
    public static final String ACCENT_COLOR_INT = "accent_color_int";
    ...
    public void setThemeInteger(int i){
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt(THEME_INT, i);
        editor.apply();
    }
    public void setFullscreenInteger(int i){
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt(FULLSCREEN_INT, i);
        editor.apply();
    }

    public void setColorInteger(int i) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt(COLOR_INT, i);
        editor.apply();
    }

    public static int getThemeInt(Context context) {
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        return pref.getInt("theme_int", 1);
    }
    public static int getFullscreenInt(Context context) {
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        return pref.getInt("fullscreen_int", 1);
    }

    public static int getColorInt(Context context) {
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        return pref.getInt("color_int", 1);
    }
    public static int getGardientColor (Context context) {
        switch ( getColorInt(context) ) {
            case 1:
                return R.drawable.gardient_11;
            case 2:
                return R.drawable.gardient_08;
            case 3:
                return R.drawable.gardient_02;
            case 4:
                return R.drawable.gardient_01;
        }
        return getColorInt(context);
    }


    public void setInt(String constant, int i) {
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putInt(constant, i);
        editor.apply();
    }

    public static int getInt(Context context, String preference) {
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        return pref.getInt(preference, 1);
    }
